...
public class CalendarView extends LinearLayout {
    ...
    private void initCalendarProperties(TypedArray typedArray) {
        ...
        int todayBackgroundColor = typedArray.getColor(R.styleable.CalendarView_todayBackgroundColor, 0);
        mCalendarProperties.setTodayBackgroundColor(todayBackgroundColor);
